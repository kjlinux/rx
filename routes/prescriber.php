...
Route::prefix('prescriber')->group(function () {
    ...
    Route::post('/refresh_datatable_payment', [PrescriberController::class, 'dataTableRefreshPayment'])->name('prescriber.refresh.payment');
    ...
    Route::post('/prescriber_register', [PrescriberController::class, 'prescriberRegister'])->name('prescriber.register.payment');
});
